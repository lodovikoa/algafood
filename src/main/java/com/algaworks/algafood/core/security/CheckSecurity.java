...
public @interface CheckSecurity {
    ...
    public @interface Pedidos {
        ...
        @PreAuthorize("hasAuthority('SCOPE_WRITE') and (hasAuthority('GERENCIAR_PEDIDOS') or @algaSecurity.gerenciarRestauranteDoPedido(#codigoPedido))") @Retention(RUNTIME) @Target(METHOD)
