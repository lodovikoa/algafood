...
public class CadastroRestauranteIT {
    ...
    public void setUp() {
        ...
        jsonRestauranteCorreto = ResourceUtils.getContentFromResource("/json/correto/restaurente-new-york-barbecue.json");
        jsonRestauranteSemFrete = ResourceUtils.getContentFromResource("/json/incorreto/restaurente-new-york-barbecue-sem-frete.json");
